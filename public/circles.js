...
// Social network graph
  d3.json("circles.json", function(error, graph) {
      ...
      node.append("circle")
      .attr("r", function(d) {
        if (d.size === 1) {return 75;}
        else if (d.size === 2) {return 50;}
        else {return 25;}
      }) //radius of circle
      .style("fill", function(d) { //set colors by category
              if (d.category === "sayers") {return "#7A297A";}
              else if (d.category === "writing") {return "#A30000";}
              else if (d.category === "maps") {return "#297A29";}
              else if (d.category === "web") {return "#7ACC29";}
              else if (d.category === "irish") {return "#E6E68A";}
              else if (d.category === "about") {return "#CCA37A";}
              else {return "black";}
          });
